...
export default function PuertaSeccionalFicha({ encargo, onEncargoAtendido, onGuardada }) {
...
export function FichaDetalle({ ficha: f, onCambiarEstado, onAgregarNota, onEditarEntrega, onEditarFirma, onVerFicha, onEditar, onEliminar }) {
  const med = f.medidas || {};
